...
const AssessmentPreview = ({ assessment }) => {
    ...
    return (
      <div className="bg-white rounded-lg border p-8">
        <div className="text-center">
          <h3 className="text-lg font-medium text-gray-1000">No Assessment</h3>
  ...
  const renderQuestion = (question) => {
    ...
    switch (question.type) {
      ...
      case 'file-upload':
        return (
          <div className="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center hover:border-gray-500 transition-colors">
