  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
      <div className="overflow-x-auto pb-4 bg-transparent">
        ...
        <div className="flex md:grid grid-cols-3 gap-2 min-w-[1000px] md:min-w-0 bg-transparent">
          {KANBAN_STAGES.map((stage) => (
            <div key={stage.key} className="flex-shrink-0 bg-transparent w-[400px] md:w-auto md:col-span-1">
              <div className={`rounded-lg border-2 ${stage.color} h-full`}>
                <div className="p-2 border-b border-gray-200 bg-transparent rounded-t-lg">
