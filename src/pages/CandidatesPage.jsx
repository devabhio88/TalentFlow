...
const CandidatesPage = () => {
  ...
  const [kanbanItemsPerPage] = useState(15); 
  ...
  return (
    <div className="space-y-5 bg-transparent">
      <div className="flex flex-col w-[75vw] md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
      ...
      <div className="mt-4 w-[75vw] bg-transparent">
        {viewMode === 'kanban' ? (
          <>
            <CandidatesKanban 
