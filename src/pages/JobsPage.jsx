...
const JobsPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start w-[75vw] justify-between sm:items-center">
        <div className="w-1/2">
          <SearchInput
      ...
      {totalPages > 1 && (
        <div className="mt-4 flex md:w-[50vw] items-center justify-center">
          <Pagination
