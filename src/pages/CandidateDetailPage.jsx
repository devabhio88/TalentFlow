...
const CandidateDetailPage = () => {
  ...
  if (!candidate) {
    return (
      <div className="text-center py-12">
        <h3 className="text-lg font-medium text-white">Candidate not found</h3>
  ...
  return (
    <div className="px-4 lg:w-[75vw] sm:px-6 lg:px-8">
      <Link
        to="/candidates"
        className="inline-flex items-center text-sm text-gray-300 hover:text-gray-300 mb-6"
      >
        <ArrowLeft className="w-4 h-4 mr-2" />
        Back to Candidates
      </Link>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="space-y-6">
          <div className="bg-transparent shadow rounded-lg">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 flex items-center space-x-4 text-sm text-gray-300">
