...
const AssessmentsPage = () => {
  ...
  return (
    <div className="space-y-6 lg:w-[75vw] bg-transparent">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold text-white">Assessments</h1>
          <p className="text-gray-300">Create and manage job-specific assessments and quizzes</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 bg-transparent">
        {assessments?.map((assessment) => (
          <Card key={assessment.id} className="hover:shadow-md transition-shadow bg-transparent">
        ...
        {(!assessments || assessments.length === 0) && (
          <div className="col-span-full text-center py-12 bg-transparent rounded-lg">
      ...
      >
        {!currentAssessment && (
          <div className="mb-6 p-4 border rounded-md bg-transparent">
